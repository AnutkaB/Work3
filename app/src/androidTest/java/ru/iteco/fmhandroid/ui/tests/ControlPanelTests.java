...
public class ControlPanelTests {
    ...
    @Story("Создание новости во вкладке \"Панель управления\"")
    @Test
    ...
    @Story("Удаление новости во вкладке \"Панель управления\"")
    @Test
    ...
    @Story("Редактирование новости во вкладке \"Панель управления\"")
    @Test
    ...
    @Story("Смена статуса новости, находящаяся в статусе \"Активна\" на статус \"Не активна\", во вкладке \"Панель управления\"")
    @Test
    ...
    @Story("Поле \"Категория\" пустое, при создании новости, во вкладке \"Панель управления\"")
    @Test
