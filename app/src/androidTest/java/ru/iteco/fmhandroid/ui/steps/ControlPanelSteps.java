...
public class ControlPanelSteps {
    ...
    @Step("Передвинуть ползунок активности у новости и сохранить изменения")
    ...
    public void checkInformationMessageEmptyCategoryField(String text, View decorView) {//реализовано через тоаст проверку высплывающего сообщения
